...
public class SocialSecurityConfig implements SocialConfigurer {
	...
	public UserIdSource getUserIdSource() {
		return () -> {
			...
			if (authentication == null) throw new IllegalStateException("Cannot obtain user ID: no authentication found");
	...
	public UsersConnectionRepository getUsersConnectionRepository(ConnectionFactoryLocator connectionFactoryLocator) {
		...
		repository.setConnectionSignUp(c -> c.getDisplayName());
		return repository;
	}
	...
	public DataSource dataSource() {
		...
		factory.setDatabaseName("containerproxy-social-auth");
	...
	public enum Provider {
		...
		public String getAppId(Environment environment) {
			return environment.getProperty(String.format("proxy.social.%s.app-id", this.toString()));
		}
		
		public String getAppSecret(Environment environment) {
			return environment.getProperty(String.format("proxy.social.%s.app-secret", this.toString()));
		}
	}
